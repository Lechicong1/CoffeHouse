            ...
            <nav class="sidebar-nav">
                <ul class="menu-list">
                    ...
                    <li class="menu-item <?= $currentSection === 'orders' ? 'active' : '' ?>" data-target="orders">
                        <a href="http://localhost/COFFEE_PHP/OrderAdminController" class="menu-link">
                            <span class="menu-icon">📦</span>
                    ...
                    <li class="menu-item <?= $currentSection === 'product_report' ? 'active' : '' ?>" data-target="product_report">
                        <a href="http://localhost/COFFEE_PHP/ProductReportController/index" class="menu-link">
                            <span class="menu-icon">📈</span>
