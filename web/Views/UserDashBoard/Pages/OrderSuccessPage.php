...
<head>
    ...
    <title><?php echo $data['title'] ?? 'Đặt Hàng Thành Công'; ?></title>
    <link rel="stylesheet" href="/COFFEE_PHP/Public/Css/user-style.css">
    <link rel="stylesheet" href="/COFFEE_PHP/Public/Css/order-success.css">
            ...
            <?php if (isset($data['order'])): ?>
                <div class="order-info">
                    ...
                    <div class="info-row">
                        ...
                        <span class="value">
                            <?php
                                echo $data['order']->payment_method === 'CASH'
                                    ? 'Tiền mặt'
                                    : 'Chuyển khoản';
                            ?>
                        </span>
                    ...
                    <?php if ($data['order']->payment_method === 'BANK_TRANSFER' &&
                              $data['order']->payment_status === 'AWAITING_PAYMENT'): ?>
                        <div class="payment-notice">
                            <i class="fas fa-info-circle"></i>
                            <p>Vui lòng hoàn tất thanh toán để đơn hàng được xử lý nhanh chóng.
                               Chúng tôi sẽ xác nhận đơn hàng sau khi nhận được thanh toán.</p>
                        </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
